...
namespace Blackboard.Core.Caps {
    ...
    sealed public class DivDouble: Binary<double, double, double> {

        /// <summary>Creates a divided value node.</summary>
        /// <param name="source1">This is the first parent for the source value.</param>
        /// <param name="source2">This is the second parent for the source value.</param>
        /// <param name="value">The default value for this node.</param>
        public DivDouble(IValue<double> source1 = null, IValue<double> source2 = null, double value = default) :
        ...
        public override string ToString() => "DivDouble"+base.ToString();
    }
}
