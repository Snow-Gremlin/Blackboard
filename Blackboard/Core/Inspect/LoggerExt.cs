...
namespace Blackboard.Core.Inspect {
    ...
    static public class LoggerExt {
        ...
        static public void Log(this Logger logger, Level level, S.Func<Message> fetcher) => logger?.Log(new Entry(level, fetcher));

        /// <summary>This will write to this log.</summary>
        /// <param name="level">The level to log this message at.</param>
        /// <param name="msg">The message to log.</param>
        static public void Log(this Logger logger, Level level, Message msg) => logger?.Log(level, () => msg.Clone());

        /// <summary>This will write to this log.</summary>
        /// <param name="level">The level to log this message at.</param>
        /// <param name="format">The log to log.</param>
        /// <param name="args">Any arguments to pass into the log too.</param>
        static public void Log(this Logger logger, Level level, string format, params object[] args) => logger?.Log(level, () => new Message(format, args));

        /// <summary>This will write an information log.</summary>
        /// <param name="fetcher">A factory for creating the message if and when it will be logged.</param>
        static public void Info(this Logger logger, S.Func<Message> fetcher) => logger?.Log(Level.Info, fetcher);

        /// <summary>This will write an information log.</summary>
        /// <param name="msg">The message to log.</param>
        static public void Info(this Logger logger, Message msg) => logger?.Log(Level.Info, msg);

        /// <summary>This will write an information log.</summary>
        /// <param name="format">The log to log.</param>
        /// <param name="args">Any arguments to pass into the log too.</param>
        static public void Info(this Logger logger, string format, params object[] args) => logger?.Log(Level.Info, format, args);

        /// <summary>This will write a notice log.</summary>
        /// <param name="fetcher">A factory for creating the message if and when it will be logged.</param>
        static public void Notice(this Logger logger, S.Func<Message> fetcher) => logger?.Log(Level.Notice, fetcher);

        /// <summary>This will write a notice log.</summary>
        /// <param name="msg">The message to log.</param>
        static public void Notice(this Logger logger, Message msg) => logger?.Log(Level.Notice, msg);

        /// <summary>This will write a notice log.</summary>
        /// <param name="format">The log to log.</param>
        /// <param name="args">Any arguments to pass into the log too.</param>
        static public void Notice(this Logger logger, string format, params object[] args) => logger?.Log(Level.Notice, format, args);

        /// <summary>This will write a warning log.</summary>
        /// <param name="fetcher">A factory for creating the message if and when it will be logged.</param>
        static public void Warning(this Logger logger, S.Func<Message> fetcher) => logger?.Log(Level.Warning, fetcher);

        /// <summary>This will write a warning log.</summary>
        /// <param name="msg">The message to log.</param>
        static public void Warning(this Logger logger, Message msg) => logger?.Log(Level.Warning, msg);

        /// <summary>This will write a warning log.</summary>
        /// <param name="format">The log to log.</param>
        /// <param name="args">Any arguments to pass into the log too.</param>
        static public void Warning(this Logger logger, string format, params object[] args) => logger?.Log(Level.Warning, format, args);

        /// <summary>This will write an error log.</summary>
        /// <param name="fetcher">A factory for creating the message if and when it will be logged.</param>
        static public void Error(this Logger logger, S.Func<Message> fetcher) => logger?.Log(Level.Error, fetcher);

        /// <summary>This will write an error log.</summary>
        /// <param name="msg">The message to log.</param>
        static public void Error(this Logger logger, Message msg) => logger?.Log(Level.Error, msg);

        /// <summary>This will write an error log.</summary>
        /// <param name="format">The log to log.</param>
        /// <param name="args">Any arguments to pass into the log too.</param>
        static public void Error(this Logger logger, string format, params object[] args) => logger?.Log(Level.Error, format, args);
