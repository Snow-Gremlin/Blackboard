...
namespace Blackboard.Core.Nodes.Caps {
    ...
    sealed public class Atan2<T>: Binary<T, T, T>
        ...
        static public readonly IFunction Factory = new Func<IValue<T>, IValue<T>>((input1, input2) => new Atan2<T>(input1, input2));

        /// <summary>Creates an atan2 value node.</summary>
        /// <param name="source1">This is the first parent for the source value.</param>
        /// <param name="source2">This is the second parent for the source value.</param>
        /// <param name="value">The default value for this node.</param>
        public Atan2(IValue<T> source1 = null, IValue<T> source2 = null, T value = default) :
