...
namespace Blackboard.Core.Nodes.Caps {
    ...
    sealed public class LeftShift<T>: Binary<T, T, T>
        ...
        static public readonly IFunction Factory =
            new Function<IValue<T>, IValue<T>, LeftShift<T>>((left, right) => new LeftShift<T>(left, right));

        /// <summary>Creates a left shift value node.</summary>
        /// <param name="source1">This is the first parent for the source value.</param>
        /// <param name="source2">This is the second parent for the source value.</param>
        /// <param name="value">The default value for this node.</param>
        public LeftShift(IValue<T> source1 = null, IValue<T> source2 = null, T value = default) :
