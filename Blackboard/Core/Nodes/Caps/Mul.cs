...
namespace Blackboard.Core.Nodes.Caps {
    ...
    sealed public class Mul<T>: Nary<T, T>
        ...
        static public readonly IFunction Factory = new FuncN<IValue<T>>((inputs) => new Mul<T>(inputs));

        /// <summary>Creates a product value node.</summary>
        /// <param name="parents">The initial set of parents to use.</param>
        public Mul(params IValue<T>[] parents) :
            base(parents) { }

        /// <summary>Creates a product value node.</summary>
        /// <param name="parents">The initial set of parents to use.</param>
        /// <param name="value">The default value for this node.</param>
        public Mul(IEnumerable<IValue<T>> parents = null, T value = default) :
            base(parents, value) { }
