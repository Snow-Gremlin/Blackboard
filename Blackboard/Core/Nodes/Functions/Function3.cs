...
sealed internal class Function<T1, T2, T3, TReturn> : FuncDef<TReturn>
    ...
    protected override INode PostCastBuild(INode[] nodes) => this.handle((T1)nodes[0], (T2)nodes[1], (T3)nodes[2]);
}
