...
namespace Blackboard.Core.Nodes.Inner {
    ...
    sealed public class DoubleMath<T>: Unary<T, T>
        ...
        static public readonly IFuncGroup Acos = Factory("Acos", S.Math.Acos);
        ...
        static public readonly IFuncGroup Acosh = Factory("Acosh", S.Math.Acosh);
        ...
        static public readonly IFuncGroup Asin = Factory("Asin", S.Math.Asin);
        ...
        static public readonly IFuncGroup Asinh = Factory("Asinh", S.Math.Asinh);
        ...
        static public readonly IFuncGroup Atan = Factory("Atan", S.Math.Atan);
        ...
        static public readonly IFuncGroup Atanh = Factory("Atanh", S.Math.Atanh);
        ...
        static public readonly IFuncGroup Cbrt = Factory("Cbrt", S.Math.Cbrt);
        ...
        static public readonly IFuncGroup Ceiling = Factory("Ceiling", S.Math.Ceiling);
        ...
        static public readonly IFuncGroup Cos = Factory("Cos", S.Math.Cos);
        ...
        static public readonly IFuncGroup Cosh = Factory("Cosh", S.Math.Cosh);
        ...
        static public readonly IFuncGroup Exp = Factory("Exp", S.Math.Exp);
        ...
        static public readonly IFuncGroup Floor = Factory("Floor", S.Math.Floor);
        ...
        static public readonly IFuncGroup Log = Factory("Log", S.Math.Log);
        ...
        static public readonly IFuncGroup Log10 = Factory("Log10", S.Math.Log10);
        ...
        static public readonly IFuncGroup Log2 = Factory("Log2", S.Math.Log2);
        ...
        static public readonly IFuncGroup Round = Factory("Round", S.Math.Round);
        ...
        static public readonly IFuncGroup Sin = Factory("Sin", S.Math.Sin);
        ...
        static public readonly IFuncGroup Sinh = Factory("Sinh", S.Math.Sinh);
        ...
        static public readonly IFuncGroup Sqrt = Factory("Sqrt", S.Math.Sqrt);
        ...
        static public readonly IFuncGroup Tan = Factory("Tan", S.Math.Tan);
        ...
        static public readonly IFuncGroup Tanh = Factory("Tanh", S.Math.Tanh);

        /// <summary>This is a factory for creating a new Tan instance of this node.</summary>
        /// <remarks>The integral part of the given number.</remarks>
        static public readonly IFuncGroup Truncate = Factory("Truncate", S.Math.Truncate);
        ...
        static public IFuncGroup Factory(string funcName, S.Func<double, double> func) =>
