...
sealed public class Format : ValueNode<String>, IChild {
    ...
    public Format() {
        this.format = null;
        this.args = new List<IValueParent<Object>>();
    }
    ...
    public void AddParents(IEnumerable<IValueParent<Object>> parents) =>
    ...
    public bool RemoveParents(IEnumerable<IValueParent<Object>> parents) =>
