...
namespace Blackboard.Core.Nodes.Inner {
    ...
    sealed public class LessThan<T>: Binary<T, T, Bool>
        ...
        static public readonly IFuncDef Factory =
            new Function<IValueAdopter<T>, IValueAdopter<T>, LessThan<T>>((left, right) => new LessThan<T>(left, right));

        /// <summary>Creates a less than value node.</summary>
        /// <param name="source1">This is the first parent for the source value.</param>
        /// <param name="source2">This is the second parent for the source value.</param>
        /// <param name="value">The default value for this node.</param>
        public LessThan(IValueAdopter<T> source1 = null, IValueAdopter<T> source2 = null, Bool value = default) :
            base(source1, source2, value) { }

        /// <summary>This is the type name of the node.</summary>
        public override string TypeName => "LessThan";
