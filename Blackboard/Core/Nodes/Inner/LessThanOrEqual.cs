...
namespace Blackboard.Core.Nodes.Inner {
    ...
    sealed public class LessThanOrEqual<T>: BinaryValue<T, T, Bool>
        ...
        static public readonly IFuncDef Factory =
            new Function<IValueParent<T>, IValueParent<T>, LessThanOrEqual<T>>(
        ...
        public LessThanOrEqual(IValueParent<T> source1 = null, IValueParent<T> source2 = null, Bool value = default) :
