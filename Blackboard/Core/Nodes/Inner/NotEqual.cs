...
namespace Blackboard.Core.Nodes.Inner {
    ...
    sealed public class NotEqual<T>: Binary<T, T, Bool>
        ...
        static public readonly IFuncDef Factory =
            new Function<IValueParent<T>, IValueParent<T>, NotEqual<T>>((left, right) => new NotEqual<T>(left, right));

        /// <summary>Creates a not equal value node.</summary>
        /// <param name="source1">This is the first parent for the source value.</param>
        /// <param name="source2">This is the second parent for the source value.</param>
        /// <param name="value">The default value for this node.</param>
        public NotEqual(IValueParent<T> source1 = null, IValueParent<T> source2 = null, Bool value = default) :
