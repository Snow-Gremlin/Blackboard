...
namespace Blackboard.Core.Nodes.Inner {
    ...
    sealed public class RightShift<T>: BinaryValue<T, T, T>
        ...
        static public readonly IFuncDef Factory =
            new Function<IValueParent<T>, IValueParent<T>, RightShift<T>>((left, right) => new RightShift<T>(left, right));

        /// <summary>Creates a right shift value node.</summary>
        /// <param name="source1">This is the first parent for the source value.</param>
        /// <param name="source2">This is the second parent for the source value.</param>
        /// <param name="value">The default value for this node.</param>
        public RightShift(IValueParent<T> source1 = null, IValueParent<T> source2 = null, T value = default) :
