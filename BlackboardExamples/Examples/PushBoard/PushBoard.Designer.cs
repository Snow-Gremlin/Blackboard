...
partial class PushBoard {
    ...
    private void InitializeComponent() {
        ...
        inputBools=new GroupBox();
        bool5=new CheckBox();
        bool4=new CheckBox();
        bool3=new CheckBox();
        bool2=new CheckBox();
        bool1=new CheckBox();
        inputInts=new GroupBox();
        int5=new NumericUpDown();
        int4=new NumericUpDown();
        int3=new NumericUpDown();
        int2=new NumericUpDown();
        int1=new NumericUpDown();
        inputStrings=new GroupBox();
        string5=new TextBox();
        string4=new TextBox();
        string3=new TextBox();
        string2=new TextBox();
        ...
        inputTriggers.Size=new Size(639, 65);
        ...
        trigger2.Location=new Point(138, 22);
        trigger2.Name="trigger2";
        trigger2.Size=new Size(97, 35);
        trigger2.TabIndex=1;
        ...
        trigger3.Location=new Point(270, 22);
        trigger3.Name="trigger3";
        trigger3.Size=new Size(97, 35);
        trigger3.TabIndex=2;
        ...
        trigger4.Location=new Point(402, 22);
        trigger4.Name="trigger4";
        trigger4.Size=new Size(97, 35);
        trigger4.TabIndex=3;
        ...
        trigger5.Location=new Point(534, 22);
        trigger5.Name="trigger5";
        trigger5.Size=new Size(97, 35);
        trigger5.TabIndex=4;
        ...
        bool4.Location=new Point(417, 22);
        bool4.Name="bool4";
        ...
        bool3.Location=new Point(285, 22);
        bool3.Name="bool3";
        ...
        bool2.Location=new Point(153, 22);
        bool2.Name="bool2";
        ...
        inputInts.Size=new Size(639, 65);
        ...
        // int5
        // 
        int5.Location=new Point(534, 25);
        int5.Name="int5";
        ...
        // int4
        // 
        int4.Location=new Point(402, 25);
        int4.Name="int4";
        ...
        // int3
        // 
        int3.Location=new Point(270, 25);
        int3.Name="int3";
        ...
        // int2
        // 
        int2.Location=new Point(138, 25);
        int2.Name="int2";
        ...
        inputStrings.Size=new Size(639, 65);
        ...
        // string5
        // 
        string5.Anchor=AnchorStyles.Top|AnchorStyles.Left|AnchorStyles.Right;
        string5.Location=new Point(534, 25);
        ...
        // string4
        // 
        string4.Anchor=AnchorStyles.Top|AnchorStyles.Left|AnchorStyles.Right;
        string4.Location=new Point(402, 25);
        ...
        // string3
        // 
        string3.Anchor=AnchorStyles.Top|AnchorStyles.Left|AnchorStyles.Right;
        string3.Location=new Point(270, 25);
        ...
        // string2
        // 
        string2.Anchor=AnchorStyles.Top|AnchorStyles.Left|AnchorStyles.Right;
        string2.Location=new Point(138, 25);
        ...
        // string1
        // 
        string1.Anchor=AnchorStyles.Top|AnchorStyles.Left|AnchorStyles.Right;
        string1.Location=new Point(6, 25);
        ...
        output.Controls.Add(textBox6);
        output.Controls.Add(textBox1);
        output.Controls.Add(textBox2);
        output.Controls.Add(textBox3);
        output.Controls.Add(textBox4);
        output.Controls.Add(textBox5);
        output.Location=new Point(3, 287);
        output.Name="output";
        output.Size=new Size(639, 423);
        output.TabIndex=5;
        ...
        textBox6.Location=new Point(6, 54);
        textBox6.Multiline=true;
        textBox6.Name="textBox6";
        textBox6.ReadOnly=true;
        textBox6.ScrollBars=ScrollBars.Both;
        textBox6.Size=new Size(625, 363);
        textBox6.TabIndex=15;
        // 
        // textBox1
        // 
        textBox1.Anchor=AnchorStyles.Top|AnchorStyles.Left|AnchorStyles.Right;
        textBox1.Location=new Point(534, 25);
        ...
        textBox2.Location=new Point(402, 25);
        ...
        textBox3.Location=new Point(270, 25);
        ...
        textBox4.Location=new Point(138, 25);
        ...
        textBox5.Location=new Point(6, 25);
        ...
        presets.Size=new Size(560, 23);
        presets.TabIndex=1;
        // 
        // rebuildButton
        // 
        rebuildButton.Anchor=AnchorStyles.Top|AnchorStyles.Right;
        rebuildButton.Location=new Point(569, 3);
    ...
    private GroupBox inputTriggers;
    ...
    private GroupBox inputBools;
    private CheckBox bool1;
    private CheckBox bool3;
    private CheckBox bool2;
    private CheckBox bool5;
    private CheckBox bool4;
    private GroupBox inputInts;
    private NumericUpDown int5;
    private NumericUpDown int4;
    private NumericUpDown int3;
    private NumericUpDown int2;
    private NumericUpDown int1;
    private GroupBox inputStrings;
    private TextBox string5;
    private TextBox string4;
    private TextBox string3;
    private TextBox string2;
    private TextBox string1;
