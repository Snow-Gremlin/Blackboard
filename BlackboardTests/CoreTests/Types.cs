...
public class Types {
    ...
    public void TestTypes_counter_double() {
        ...
        node.CheckImplicit(Type.Object, 1, "Implicit<object>[null](Counter<double>)");
        node.CheckNoCast  (Type.Bool);
        node.CheckExplicit(Type.Int, "Explicit<int>[0](Counter<double>)");
        node.CheckInherit (Type.Double, 1);
        node.CheckImplicit(Type.String, 1, "Implicit<string>[](Counter<double>)");
        node.CheckNoCast  (Type.FuncGroup);
        node.CheckNoCast  (Type.FuncDef);
        node.CheckNoCast  (Type.Namespace);
        node.CheckNoCast  (Type.CounterInt);
    ...
    public void TestTypes_latch_int() {
        ...
        node.CheckInherit (Type.Node, 2);
        node.CheckNoCast  (Type.Trigger);
        node.CheckImplicit(Type.Object, 1, "Implicit<object>[null](Latch<int>)");
        node.CheckNoCast  (Type.Bool);
        node.CheckInherit (Type.Int, 1);
        node.CheckImplicit(Type.Double, 1, "Implicit<double>[0](Latch<int>)");
        node.CheckImplicit(Type.String, 1, "Implicit<string>[](Latch<int>)");
        node.CheckNoCast  (Type.FuncGroup);
        node.CheckNoCast  (Type.FuncDef);
        node.CheckNoCast  (Type.Namespace);
        node.CheckNoCast  (Type.CounterInt);
